...
class Running(OlympicsBase):
    def __init__(self, map, seed=None, max_episode_steps=200, expand_state=False, sparse_reward=True):
        ...
        observation_shape = 5 if expand_state else 3
    ...
    def is_terminal(self, step_reward):
        ...
        elif self.sparse_reward and self.agent_list[0].finished:  # 成功
            done = True
            info = {'is_success': True}
        elif not self.sparse_reward and step_reward > -0.2:  # 成功
            done = True
            info = {'is_success': True}
        return done, info
    ...
    def step(self, actions_list):
        ...
        done, info = self.is_terminal(step_reward)

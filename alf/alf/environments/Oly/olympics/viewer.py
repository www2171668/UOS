...
class Viewer():
    ...
    def draw_ball(self, pos_list, agent_list):
        ...
        for i in range(len(pos_list)):
            ...
            pygame.draw.circle(self.background, COLORS['dark'], t, 2, 2)


    def draw_direction(self, pos_list, a_list):
        """
        :param pos_list: position of agent center
        :param a_list: acceleration of agent
        """
        ...
        for i in range(len(pos_list)):
            ...
            if a_x != 0 or a_y != 0:
                ...
                pygame.draw.line(self.background, color=[0, 0, 0],
                                 start_pos=[start_x, start_y], end_pos=[end_x, end_y], width=2)
    ...
    def draw_view(self, obs, agent_list):  # obs: [2, 100, 100] list
        ...
        for agent_idx in range(len(obs)):
            ...
            pygame.draw.circle(self.background, COLORS["black"], [coord[agent_idx] + 10, 55 + agent_list[agent_idx].r], 2,
                               width=0)
            pygame.draw.circle(self.background, COLORS["dark"], [coord[agent_idx] + 10, 55 + agent_list[agent_idx].r], 2,
                               width=0)
